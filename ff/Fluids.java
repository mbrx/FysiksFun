...
public class Fluids {
	...
	public static BlockFluid asFluid[] = new BlockFluid[4096];
	...
	private static void patchModLiquid(String stillName, String flowingName,
		...
		if (oldBlockFlowing != null && oldBlockStill != null
			...
			BlockFluid blockFlowing = new BlockFluid(oldBlockFlowing,
			...
			if (hasTwoNames) {
				...
				BlockFluid blockStill = new BlockFluid(oldBlockStill,
