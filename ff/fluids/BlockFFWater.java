...
public class BlockFFWater extends BlockFFFluid {

  public BlockFFWater(int blockID, Material water, int blockID2, int stillID, String string, Block replacedBlock) {
