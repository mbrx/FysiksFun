...
/**
 * Class used for creating sets of markupdates to be done at a later time. The origId and origMeta is not hashed, thus
 * you cannot have multiple instances with the coordinate but different id/meta values in the same set. This is a
 * feature, not a bug.
 */
public class ChunkMarkUpdateTask extends CoordinateWXYZ {
  ...
  public int getOrigMeta() { return origMeta; }
}
