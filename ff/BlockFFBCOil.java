...
public class BlockFFBCOil extends BlockBuildcraftFluid {
  ...
  public static void patchBC() {

    {
      ...
      oilFFWrapped = new BlockFluid(origOil.blockID, origOil.blockMaterial, origOil.blockID, origOil.blockID, "blockOil",origOil);
      Fluids.registerLiquidBlock(oilFFWrapped);
      Block.blocksList[origOil.blockID] = null;
      oil = new BlockFFBCOil(origOil.blockID, origOil.getFluid(), origOil.blockMaterial, oilFFWrapped, origOil);
...

    {
      ...
      fuelFFWrapped = new BlockFluid(origFuel.blockID, origFuel.blockMaterial, origFuel.blockID, origFuel.blockID, "blockFuel",origFuel);
      Fluids.registerLiquidBlock(fuelFFWrapped);
      Block.blocksList[origFuel.blockID] = null;
      fuel = new BlockFFBCOil(origFuel.blockID, origFuel.getFluid(), origFuel.blockMaterial, fuelFFWrapped, origFuel);
  ...
  public BlockFFBCOil(int id, Fluid fluid, Material material, BlockFluid toBeWrapped, BlockBuildcraftFluid bcFluidBlock) {
