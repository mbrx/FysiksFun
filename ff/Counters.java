...
public class Counters {
  ...
  //  System.out.println("Fluid updates: " + fluidUpdates + " content calls: "+fluidSetContent);
   ...
   // System.out.println("Gas ticks: " + gasTicks);
    ...
    /*
     * System.out.println("Liquid Tick Queue: " + (liquidQueueCounter / 300) + " per tick (" + totsize + " used "+
     * FysiksFun.blockTickQueueFreePool.size() + " free pool) smallLiquidExtraTicks: "+smallLiquidExtraTicks/300);
     * System.out.println("Mark counter: " + (markQueueCounter / 300) + " per tick");
     */
    // System.out.println("Erosion events: " + erosionCounter);
    // System.out.println("Rain: +" + rainCounter + " evaporation: " + directEvaporation + "/" + worldHeatEvaporation +
    // "/" + indirectEvaporation + " humidification: +" + humidification);
    ...
    // System.out.println("Observers in world: " + FysiksFun.observers.size() + " early marks: " + earlyTick +
    // " total");
